...
from third_party.parametrica import Fieldset, Field, InRange, Min, Parametrica, Max, Match
from third_party.parametrica.io import YAMLFileConfigIO, VirtualYAMLFileConfigIO
from third_party.parametrica.predefined.network import HTTPServer, Credentials, PortField
...
class MoreFields(Fieldset):
    ...
    email = Field[str]('some_email@gmail.com').label('Email адрес').rule(
        Match(r'([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9_-]+)'))
